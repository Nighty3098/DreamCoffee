    ...
    drinks: [
      {
        ...
        ingredients: ['Espresso coffee', 'Milk', 'Milk foam'],
        weight: '180 ml',
      },
      {
        name: 'Caramel Latte',
        ...
        ingredients: ['Espresso coffee', 'Milk', 'Caramel syrup', 'Whipped cream'],
        weight: '250 ml',
      },
      {
        name: 'Flat White',
      ...
      },
      {
        ...
        ingredients: ['Espresso coffee', 'Hot chocolate', 'Milk', 'Whipped cream'],
        weight: '240 ml',
      },
      {
        name: 'Iced Americano',
    ...
    desserts: [
      {
        ...
        ingredients: ['Shortbread cookies', 'Butter', 'Cream cheese', 'Sugar', 'Eggs'],
        weight: '150 g',
      },
      {
        name: 'Brownie',
        ...
        ingredients: ['Dark chocolate', 'Butter', 'Eggs', 'Wheat flour', 'Cocoa powder'],
        weight: '100 g',
      },
      {
        name: 'Tiramisu',
